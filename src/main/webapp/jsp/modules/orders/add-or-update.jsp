...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑订单</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑订单</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>商品名称</label>
					<input name="goodname" id="goodname" name="goodname" class="form-control" placeholder="请输入商品名称">
				</div>
				...
				<div class="form-item">
					<label>购买数量</label>
					<input name="buynumber" id="buynumber" name="buynumber" class="form-control" placeholder="请输入购买数量">
				</div>
				<div class="form-item">
					<label>价格</label>
					<input name="price" id="price" name="price" class="form-control" placeholder="请输入价格">
				</div>
				<div class="form-item">
					<label>折扣价格</label>
					<input name="discountprice" id="discountprice" name="discountprice" class="form-control" placeholder="请输入折扣价格">
				</div>
				<div class="form-item">
					<label>总价格</label>
					<input name="total" id="total" name="total" class="form-control" placeholder="请输入总价格">
				</div>
				<div class="form-item">
					<label>折扣总价格</label>
					<input name="discounttotal" id="discounttotal" name="discounttotal" class="form-control" placeholder="请输入折扣总价格">
				</div>
				<div class="form-item">
					<label>支付类型</label>
				...
				<div class="form-item">
					<label>地址</label>
					<input name="address" id="address" name="address" class="form-control" placeholder="请输入地址">
				</div>
				<div class="form-item">
					<label>电话</label>
					<input name="tel" id="tel" name="tel" class="form-control" placeholder="请输入电话">
				</div>
				<div class="form-item">
					<label>收货人</label>
					<input name="consignee" id="consignee" name="consignee" class="form-control" placeholder="请输入收货人">
				</div>
				<div class="form-item">
					<label>备注</label>
				...
				<div class="form-item">
					<label>商品类型</label>
					<input name="goodtype" id="goodtype" name="goodtype" class="form-control" placeholder="请输入商品类型">
				</div>
										
				<div class="form-item-file" id="logistics">
					<label>物流</label>
					<div class="upload btn-file">
						插入图片
						<input id="logisticsupload" name="file" type="file">
					</div>
