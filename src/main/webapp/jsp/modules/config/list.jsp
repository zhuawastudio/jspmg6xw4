...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">轮播图管理管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>轮播图管理管理</span></li>
				<li class="breadcrumb-item-two"><span>轮播图管理列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            valueImg.setAttribute('src',item.value?(baseUrl+item.value.split(",")[0]):'');
