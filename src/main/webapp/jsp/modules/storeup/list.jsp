...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">收藏表管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>收藏表列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>名称</label>
					<input type="text" id="nameSearch" class="form-control form-control-sm" placeholder="请输入名称" aria-controls="tableId">
				</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>图片</th>
						<th onclick="sort('inteltype')">推荐类型<i id="inteltypeIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var inteltypeCell  = document.createElement('td');

						 inteltypeCell.innerHTML = item.inteltype;

			row.appendChild(inteltypeCell);
