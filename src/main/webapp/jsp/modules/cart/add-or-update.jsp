...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑购物车表</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑购物车表</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>商品表名</label>
					<input name="tablename" id="tablename" name="tablename" class="form-control" placeholder="请输入商品表名">
				</div>
				<div class="form-item">
					<label>商品id</label>
					<input name="goodid" id="goodid" name="goodid" class="form-control" placeholder="请输入商品id">
				</div>
				<div class="form-item">
					<label>商品名称</label>
				...
				<div class="form-item">
					<label>单价</label>
					<input name="price" id="price" name="price" class="form-control" placeholder="请输入单价">
				</div>
				<div class="form-item">
					<label>会员价</label>
					<input name="discountprice" id="discountprice" name="discountprice" class="form-control" placeholder="请输入会员价">
				</div>
				<div class="form-item">
					<label>商品类型</label>
